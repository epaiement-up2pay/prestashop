...
class Checkout extends Base
{
    ...
    public $elements = array(
        ...
        'Crédit Agricole Credit Card' => "//input[@type='radio'][contains(@data-module-name, 'wd-creditcard')]",
        'Crédit Agricole PayPal' => "//input[@type='radio'][contains(@data-module-name, 'wd-paypal')]",
