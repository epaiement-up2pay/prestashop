...
class OrderManager
{
    ...
    public function createOrderState($stateName)
    {
        if (!\Configuration::get($stateName)) {
            ...
            $orderState->module_name = 'creditagricolepaymentgateway';
    ...
    private function getOrderStateInfo($stateName)
    {
        switch ($stateName) {
            case self::WIRECARD_OS_STARTING:
                return array(
                    'de' => 'Crédit Agricole Bezahlung started',
                    'en' => 'Crédit Agricole payment started',
                );
            case self::WIRECARD_OS_AUTHORIZATION:
                return array(
                    'de' => 'Crédit Agricole Bezahlung authorisiert',
                    'en' => 'Crédit Agricole payment authorized',
                );
            case self::WIRECARD_OS_AWAITING:
            default:
                return array(
                    'de' => 'Crédit Agricole Bezahlung ausständig',
                    'en' => 'Crédit Agricole payment awaiting'
                );
        }
    }
