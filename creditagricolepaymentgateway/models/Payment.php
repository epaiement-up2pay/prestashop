...
abstract class Payment extends PaymentOption
{
    ...
    public function __construct()
    {
        ...
        $potentialPath = _PS_MODULE_DIR_ . \CreditAgricolePaymentGateway::NAME
        ...
        $this->name = 'Crédit Agricole Payment Processing Gateway';
    ...
    public function getFormTemplateWithData()
    {
        try {
            $templatePath = join(
                DIRECTORY_SEPARATOR,
                [_PS_MODULE_DIR_, \CreditAgricolePaymentGateway::NAME, 'views', 'templates', 'front', static::TYPE  . ".tpl"]
            );
