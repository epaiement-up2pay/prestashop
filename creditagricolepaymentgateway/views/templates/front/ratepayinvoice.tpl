...
<form id="payment-form" action="{$action_link}" method="POST">
    ...
    <div id="payment-processing-gateway-ratepay-form">
        ...
        <small id="invoiceDataProtectionHint" class="text-danger" style="display: none;">{lFallback s='text_terms_notice' mod='creditagricolepaymentgateway'|unescape:"htmlall"}</small>
    </div>
</form>