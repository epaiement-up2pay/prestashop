 ...
 * @since 1.0.0
 */
class CreditAgricolePaymentGateway extends PaymentModule
{
    /**
     * @var string
     * @since 2.1.0
     */
    const NAME = 'creditagricolepaymentgateway';
    ...
    /**
     * CreditAgricolePaymentGateway constructor.
     *
     * @since 1.0.0
     */
    ...
    /**
     * Create content on Crédit Agricole Payment Processing Gateway settings page
     *
     * @return null|string
     * @since 1.0.0
     */
    public function getContent()
    {
        ...
        $this->html .= $this->displayCreditAgricolePaymentGateway();
    ...
    /**
     * Display info text for Crédit Agricole Payment Processing Gateway page
     *
     * @return string
     * @since 1.0.0
     */
    protected function displayCreditAgricolePaymentGateway()
    {
    ...
    public function hookActionFrontControllerSetMedia()
    {
        ...
        $link = new Link;
        $ajaxLink = $link->getModuleLink('creditagricolepaymentgateway', 'configprovider');
        $ccVaultLink = $link->getModuleLink('creditagricolepaymentgateway', 'creditcard');
    ...
    public function hookActionDispatcher()
    {
        ...
        $this->context->smarty->registerPlugin('function', 'lFallback', array('CreditAgricolePaymentGateway', 'lFallback'));
    }
    ...
    public static function getTranslationForLanguage($iso_lang, $key, $file_name)
    {
        ...
        include($file);
        $hashed_key = md5($key);
        $translation_key = '<{'.'creditagricolepaymentgateway'.'}prestashop>'.\Tools::strtolower($file_name).'_'.$hashed_key;
    ...
    public static function lFallback($params, $smarty)
    {
        ...
        if ($translation === $key) {
            $translation = CreditAgricolePaymentGateway::getTranslationForLanguage('en', $key, $basename);
        }
